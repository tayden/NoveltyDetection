...
SEED = 1
CLASSES = 100
MODEL_PATH_ROOT = './weights/wrn-28-10-cifar100'
...
train_loader = torch.utils.data.DataLoader(
    datasets.CIFAR100(os.path.join(DATA_DIR, 'cifar100'), train=True, transform=transform, download=True),
...
df.to_pickle('./results/cifar100_wrn28_10_liang2018.pkl')
df_odin.to_pickle('./results/cifar100_wrn28_10_odin_liang2018.pkl')
